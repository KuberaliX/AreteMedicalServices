    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Recognition Section */}
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl p-12 text-white text-center mb-16">
            ...
            <div className="inline-flex items-center gap-4 px-8 py-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div>
                <div className="text-lg font-bold mb-1">Fast Company's Most Innovative Companies</div>
                <div className="text-sm text-gray-300">Annual Prestigious List of the World's Most Innovative Companies of 2025</div>
              </div>
            </div>
          </div>
