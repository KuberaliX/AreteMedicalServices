        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 lg:py-24">
          ...
          <div className="text-center mb-12">
            <div className="inline-block mb-6">
              <span className="inline-flex items-center px-6 py-3 rounded-full text-lg font-semibold bg-red-100 text-red-700 border-2 border-red-200">
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl text-gray-700 leading-relaxed max-w-5xl mx-auto mb-10 font-medium">
              The <span className="font-bold text-gray-900">PortableConnect®</span> is a medical device that delivers 
              <span className="font-bold text-gray-900"> clinician-controlled physical therapy sessions</span> to patients 
              in their homes. Recover from knee replacement, hip replacement, ACL, and other surgeries in 
              <span className="font-bold text-red-600"> half the time</span> with faster outcomes and better pain management.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto mb-12">
            <div className="relative group">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-red-200">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/70 to-transparent p-6 lg:p-8">
                  <p className="text-white text-xl lg:text-2xl font-bold text-center">
                    See PortableConnect® in Action
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
            <Link
              href="/devices"
              className="bg-red-600 text-white px-12 py-6 rounded-xl font-bold text-xl lg:text-2xl hover:bg-red-700 transition-all duration-300 text-center shadow-xl hover:shadow-2xl min-w-[280px]"
            >
              Explore Our Devices
            </Link>
            {/* <Link
          ...
          <div className="flex flex-wrap justify-center items-center gap-10 pt-8 border-t-2 border-gray-300">
            <div className="flex items-center gap-3">
              <svg className="w-8 h-8 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span className="text-lg lg:text-xl font-semibold text-gray-800">FDA Approved</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg lg:text-xl font-semibold text-gray-800">Clinically Proven</span>
            </div>
            <div className="flex items-center gap-3">
              <svg className="w-8 h-8 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              <span className="text-lg lg:text-xl font-semibold text-gray-800">4.9/5 Rating</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <div className="text-gray-300 text-lg font-medium">Therapy Sessions</div>
              <div className="text-gray-500 text-sm mt-1">Completed by patients</div>
            </div>
            <div className="text-center group">
              <div className="text-5xl lg:text-6xl font-extrabold mb-3 bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                50%
              ...
              <div className="text-gray-500 text-sm mt-1">Recover in half the time</div>
            </div>
            <div className="text-center group">
              <div className="text-5xl lg:text-6xl font-extrabold mb-3 bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                2 Weeks
              </div>
              <div className="text-gray-300 text-lg font-medium">Range of Motion</div>
              <div className="text-gray-500 text-sm mt-1">Meet/exceed pre-op ROM</div>
            </div>
            <div className="text-center group">
              <div className="text-5xl lg:text-6xl font-extrabold mb-3 bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                $2K-$6K
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="group relative bg-white rounded-2xl p-8 border-2 border-gray-100 hover:border-red-200 transition-all duration-300 hover:shadow-2xl">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Accelerated Recovery At Home</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  Begin therapeutic motion as early as the day of surgery. At-home rehabilitation enables knee and hip patients 
                  to regain range of motion in half the time of traditional physical therapy.
                </p>
            ...
            <div className="group relative bg-white rounded-2xl p-8 border-2 border-gray-100 hover:border-red-200 transition-all duration-300 hover:shadow-2xl">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Superior Clinical Outcomes</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  On average, patients meet or exceed their pre-operative range of motion by 2 weeks after surgery, 
                  report significant reduction in pain and narcotic usage, and regain full activity weeks earlier.
                </p>
                <div className="flex items-center text-red-600 font-semibold group-hover:translate-x-2 transition-transform duration-300">
                  <span>Learn more</span>
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group relative bg-white rounded-2xl p-8 border-2 border-gray-100 hover:border-red-200 transition-all duration-300 hover:shadow-2xl">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Lower Cost of Medical Care</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  With coverage by most insurance payers, faster recovery times, fewer readmissions, and reduced physical therapy visits, 
                  PortableConnect dramatically cuts the cost of care for patients and providers alike.
                </p>
                <div className="flex items-center text-red-600 font-semibold group-hover:translate-x-2 transition-transform duration-300">
                  <span>Learn more</span>
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
